  ...
  return (
    <section id="about" ref={ref} className="py-20 bg-white dark:bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 bg-cream-100 dark:bg-neutral-900 rounded-xl border border-primary-100 dark:border-white/10">
                <div className="flex items-center mb-3">
                  <Users className="w-6 h-6 text-primary-600 mr-3" />
                  <h4 className="font-semibold text-neutral-900 dark:text-white">Customer Websites</h4>
                </div>
              ...
              <div className="p-6 bg-cream-100 dark:bg-neutral-900 rounded-xl border border-primary-100 dark:border-white/10">
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="font-semibold text-neutral-900 dark:text-white">Admin Dashboards</h4>
                </div>
                <p className="text-neutral-600 dark:text-neutral-400 text-sm">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 bg-white dark:bg-neutral-900 p-6 rounded-xl shadow-xl border border-primary-100 dark:border-white/10"
            >
              <div className="text-center">
                <div className="text-3xl font-bold text-primary-600 mb-1">500+</div>
                <div className="text-sm text-neutral-600 dark:text-neutral-400">Restaurants Transformed</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <h3 className="text-3xl font-display font-bold text-neutral-900 dark:text-white mb-12">
            Our Core Values
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Results-Driven</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Innovation-First</h4>
              <p className="text-neutral-600 dark:text-neutral-400">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Always Available</h4>
              <p className="text-neutral-600 dark:text-neutral-400">
