...
const sources = [
  ...
  { icon: Zap,         label: 'POS & booking system exports',  color: 'text-primary-600 dark:text-primary-400',  bg: 'bg-primary-500/10' },
];
  ...
  <div className="space-y-8 text-neutral-700 dark:text-slate-300">
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {sources.map((s) => (
          <div key={s.label} className="flex items-center gap-3 p-4 rounded-xl bg-cream-100 dark:bg-white/[0.03] border border-primary-200/70 dark:border-white/[0.06]">
    ...
    <div>
      ...
      <div className="space-y-3">
        {questions.map((q) => (
          <div key={q.q} className="p-4 rounded-xl bg-cream-100 dark:bg-white/[0.03] border border-primary-200/70 dark:border-white/[0.06]">
    ...
    <div>
      ...
      <div className="space-y-3">
        {[
          ...
          <div key={m.name} className="flex items-start gap-3 p-4 rounded-xl bg-cream-100 dark:bg-white/[0.03] border border-primary-200/70 dark:border-white/[0.06]">
    ...
    {/* Privacy */}
    <div className="flex items-start gap-4 p-5 rounded-xl bg-glow-50 dark:bg-glow-500/[0.05]
                    border border-glow-300 dark:border-glow-500/15">
    ...
    {/* Stats */}
    <div className="grid grid-cols-3 gap-4 p-5 rounded-xl bg-gradient-to-r from-glow-500/[0.08] to-primary-500/[0.08] border border-primary-200/70 dark:border-white/[0.06]">
      {[
        { v: '< 2s',  l: 'Answer time' },
