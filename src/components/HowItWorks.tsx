...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" ref={ref} className="py-24 bg-cream-100 dark:bg-black relative overflow-hidden">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                ...
                <span className={`text-5xl font-bold ${step.color} opacity-30 dark:opacity-20 font-display`}>
                  {step.number}
                </span>
              </div>
